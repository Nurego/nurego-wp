...
function nwp_custom_submenu_page_callback() {
    ...
    wp_enqueue_script('nwp_jscolor'); ?>
     ...
     <?php foreach( $nwp_options as $key => $value) {
        echo $key. ' | '. $value. '<br />';
    };?>
            ...
            <table class="form-table">
               <tr valign="top">
                <th scope="row"><b><?php _e('Nurego Live API Key', 'nwp-text-domain');?>:</b></th>
                        <td><input type="text" id="nwp_key_settings[live_api_key]" name="nwp_key_settings[live_api_key]" size="40" value="<?php echo (isset($nwp_key_options['live_api_key'])) ? $nwp_key_options['live_api_key'] : '' ;?>" />
                ...
                <th scope="row"><b><?php _e('Nurego Test API Key', 'nwp-text-domain');?>:</b></th>
                        <td><input type="text" id="nwp_key_settings[test_api_key]" name="nwp_key_settings[test_api_key]" size="40" value="<?php echo (isset($nwp_key_options['test_api_key'])) ? $nwp_key_options['test_api_key'] : '';?>" />
              ...
              <?php } else if($tab == 'display') {?>
               ...
               <tr valign="top">
                <th scope="row"><?php _e('Use theme styling?', 'nwp-text-domain');?></th>
                    <td><input type="checkbox" id='nwp_display_settings[use_theme_css]' name='nwp_display_settings[use_theme_css]' value='1' <?php checked(1, isset($nwp_display_options['use_theme_css']) );?> />
                        <label class="description" for="nwp_display_settings[use_theme_css]"><?php _e('Check to use your built in theme settings for the pricing table. Overrides all other style settings.');?></label>
                    </td>
                </tr> 
                <tr valign="top">
                ...
                <th scope="row"><?php _e('Table Background Color', 'nwp-text-domain');?></th>
                    <td><input type="text" class="color" id='nwp_display_settings[background]' name='nwp_display_settings[background]' value="<?php echo (isset($nwp_display_options['background'])) ? $nwp_display_options['background'] : '';?>" />
                ...
                <th scope="row"><?php _e('Plan Font Color', 'nwp-text-domain');?></th>
                    <td><input type="text" class="color" id'nwp_display_settings[plan_font_color]' name='nwp_display_settings[plan_font_color]' value="<?php echo (isset($nwp_display_options['plan_font_color'])) ? $nwp_display_options['plan_font_color'] : '';?>" />
                ...
                <th scope="row"><?php _e('Price Font Color', 'nwp-text-domain');?></th>
                    <td><input type="text" class="color" id='nwp_display_settings[price_color]' name='nwp_display_settings[price_color]' value="<?php echo (isset($nwp_display_options['price_color'])) ? $nurego_display_options['price_color'] : '' ;?>" />
                ...
                <th scope="row"><?php _e('Plan Background Color', 'nwp-text-domain');?></th>
                    <td><input type="text" class="color" id='nwp_display_settings[plan_background_color]' name='nwp_display_settings[plan_background_color]' value="<?php echo (isset($nwp_display_options['plan_background_color'])) ? $nwp_display_options['plan_background_color'] : '';?>" />
                ...
                <th scope="row"><?php _e('Button Color', 'nwp-text-domain');?></th>
                    <td><input type="text" class="color" id='nwp_display_settings[button_color]' name='nwp_display_settings[button_color]' value="<?php echo (isset($nwp_display_options['button_color'])) ? $nwp_display_options['button_color'] : '';?>" />
                ...
                <th scope="row"><?php _e('Button Text Color', 'nwp-text-domain');?></th>
                    <td><input type="text" class="color" id='nwp_display_settings[button_text_color]' name='nwp_display_settings[button_text_color]' value="<?php echo (isset($nwp_display_options['button_text_color'])) ? $nwp_display_options['button_text_color'] : '';?>" />
                ...
                <th scope="row"><?php _e('Price Label', 'nwp-text-domain');?>:</th>
                        <td><input type="text" id="nwp_display_settings[label_price]" name="nwp_display_settings[label_price]" value="<?php echo (isset($nwp_display_options['label_price'])) ? $nwp_display_options['label_price'] : '';?>" />
                ...
                <th scope="row"><?php _e('Select Button Text', 'nwp-text-domain');?>:</th>
                        <td><input type="text" id="nwp_display_settings[label_select]" name="nwp_display_settings[label_select]" value="<?php echo (isset($nwp_display_options['label_select'])) ? $nwp_display_options['label_select'] : '';?>" />
                ...
                <th scope="row"><?php _e('Price Prefix', 'nwp-text-domain');?>:</th>
                        <td><input type="text" id="nwp_display_settings[label_before_price]" name="nwp_display_settings[label_before_price]" value="<?php echo (isset($nwp_display_options['label_before_price'])) ? $nwp_display_options['label_before_price'] : '';?>" />
                 ...
                 <th scope="row"><?php _e('Price Suffix', 'nwp-text-domain');?>:</th>
                        <td><input type="text" id="nwp_display_settings[label_after_price]" name="nwp_display_settings[label_after_price]" value="<?php echo (isset($nwp_display_options['label_after_price'])) ? $nwp_display_options['label_after_price'] : '';?>" />
                ...
                <th scope="row"><?php _e('Custom CSS Url', 'nwp-text-domain');?>:</th>
                        <td>
                            <input type="text" id="nwp_display_settings[css_url]" name="nwp_display_settings[css_url]" value="<?php echo (isset($nwp_display_options['css_url'])) ? $nwp_display_options['css_url'] : '';?>" />
                            <label class="description" for="nwp_display_settings[css_url]"><?php _e('The ABSOLUTE Url to the custom CSS file to be used. (Will override current settings)',
                                                                              'nwp-text-domain');?>.</label>
                        </td>
                </tr>
                  <tr valign="top">
               ...
               <?php } else {?>
                ...
                <th scope="row"><?php _e('Select Button URL', 'nwp-text-domain');?>:</th>
                        <td>
                            <input type="text" id="nwp_render_settings[select_url]" name="nwp_render_settings[select_url]" value="<?php echo (isset($nwp_render_options['select_url'])) ? $nwp_render_options['select_url'] : '';?>" />
                            <label class="description" for="nwp_render_settings[select_url]"><?php _e('URL to send the user to after selecting a plan. Ex http://foo.com/?plan_id=', 
                                                                                 'nwp-text-domain');?>.</label>
                        </td>
                </tr>
               <tr valign="top">
                <th scope="row"><?php _e('Loading Timeout', 'nwp-text-domain');?>:</th>
                        <td><input type="text" id="nwp_render_settings[time_out]" name="nwp_render_settings[time_out]" value="<?php echo (isset($nwp_render_options['time_out'])) ? $nwp_render_options['time_out'] : '5000';?>" />
                        <label class="description" for="nwp_render_options[time_out]"><?php _e('The amount of time in milliseconds to wait before timing out when loading an offering',
                                                                           'nwp-text-domain');?>.</label>
                        </td>
                </tr>
                 <tr valign="top">
